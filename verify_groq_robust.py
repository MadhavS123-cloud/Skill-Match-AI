...
# Absolute path for robust importing
models_path = r"c:\Users\Lenovo\OneDrive\Desktop\skill match ai\Skill-Match-AI\models"
if models_path not in sys.path:
    sys.path.append(models_path)

# In models directory, we have:
# ats_checker.py
# rejection_simulator.py
# job_expander.py
# style_analyzer.py

try:
    from ats_checker import check_ats_friendliness
    from rejection_simulator import simulate_rejection
    from job_expander import expand_job_requirements
    from style_analyzer import analyze_company_style
except ImportError as e:
    print(f"Import Error: {e}")
    # Try alternate relative
    sys.path.append(".")
...
load_dotenv(r"c:\Users\Lenovo\OneDrive\Desktop\skill match ai\Skill-Match-AI\.env")
